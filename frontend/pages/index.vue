...
<template>
    ...
    <div
        ...
        <div
            class="absolute xs:w-3/4 xs:h-1/5 sm:h-2/4 lg:w-1/3 lg:h-2/4 z-50 top-20 xs:left-12 lg:left-20 bg-white/80 p-6 text-black rounded-lg shadow-lg font-mono text-center">
